...
const TextStyle requestCardHeading = TextStyle(
  fontFamily: 'Poppins', fontSize: 30, fontWeight: FontWeight.bold, color: Colors.red
);
...
const TextStyle darkTinyText = TextStyle(fontSize: 13, color: Colors.black ,fontFamily: 'Poppins');

const TextStyle gridTitle =
    TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: darkerBlue,fontFamily: 'Poppins');
...
const kTextFieldDecoration = InputDecoration(
    labelText: '',
    labelStyle:
    TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 17,fontFamily: 'Poppins'),
