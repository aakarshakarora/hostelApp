...
import 'package:hostel_app/view/mess/messUser.dart';
...
class _MessRegisterState extends State<MessRegister> {
  ...
  TextEditingController workEmailIdMessInputController =
  ...
  TextEditingController contactNumberMessInputController =
  new TextEditingController();
  TextEditingController empIdMessController = new TextEditingController();
  TextEditingController designationMessInputController =
  new TextEditingController();
  TextEditingController userNameMessInputController =
  new TextEditingController();
  TextEditingController personalEmailIdMessInputController =
  new TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Register as Mess In Charge", style: lightHeading),
        centerTitle: true,
      ),
      body: Container(
                          ...
                          Navigator.pushAndRemoveUntil(
                              ...
                              MaterialPageRoute(
                                  builder: (context) =>
                                      MessUser()),
                                  (_) => false),
                          workEmailIdMessInputController
                              .clear(),
                          pwdInputController.clear(),
                          confirmPwdInputController.clear(),
                          contactNumberMessInputController
                              .clear(),
                          designationMessInputController.clear(),
                          userNameMessInputController.clear(),
                          personalEmailIdMessInputController
                              .clear(),
