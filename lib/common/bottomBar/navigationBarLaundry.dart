...
import 'package:hostel_app/view/dashboard/Laundry/dashboard_laundry.dart';
import 'package:hostel_app/view/myProfile/laundry/laundryProfile.dart';
...
class LaundryBar extends StatefulWidget {
  LaundryBar({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _LaundryBarState createState() => _LaundryBarState();
}

class _LaundryBarState extends State<LaundryBar> with AutomaticKeepAliveClientMixin<LaundryBar>
{
  @override
