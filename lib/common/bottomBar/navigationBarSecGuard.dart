...
import 'package:hostel_app/view/dashboard/hostel_InCharge/dashboardSecGuard.dart';
import 'package:hostel_app/view/myProfile/hostel_InCharge/secGuardProfile.dart';
...
class SecGuardBar extends StatefulWidget {
  SecGuardBar({Key key, this.title}) : super(key: key);
  final String title;

  @override
  _SecGuardBarState createState() => _SecGuardBarState();
}

class _SecGuardBarState extends State<SecGuardBar> with AutomaticKeepAliveClientMixin<SecGuardBar>
{
  @override
