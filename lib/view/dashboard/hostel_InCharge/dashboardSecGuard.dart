...
import 'package:hostel_app/function/outPass%20Verification/scanQR.dart';
...
class DashboardSecGuard extends StatefulWidget {
  @override
  _DashboardSecGuardState createState() =>
      _DashboardSecGuardState();
}

class _DashboardSecGuardState extends State<DashboardSecGuard>with AutomaticKeepAliveClientMixin {

  @override
  bool get wantKeepAlive => true;
  final FirebaseAuth _auth = FirebaseAuth.instance;

  final titles = ['स्कैन - QR '
    // ,'आगमन  - Bar'
  ];
  final titleIcon = [
    Icon(Icons.qr_code),
